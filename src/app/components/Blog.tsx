            ...
            <div id='blog' >
                ...
                <SectionWrapper title="Blog" >
                    ...
                    <div className='space-y-4' >
                        ...
                        <BlogFrame title="Students guide to becoming 'AI first' at School" description="there’s more to using ChatGPT than just helping you paraphrase" link="https://medium.com/p/d004dbc7a633" timePosted="December 2024" />
