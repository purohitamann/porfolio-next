...
export default function Experience({ role, company, startDate, endDate, description, id, link, logo }: Props) {
  return (
    <div className="flex flex-row gap-6 items-start w-full p-4">
